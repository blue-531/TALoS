...
class cylinder_asym(nn.Module):
    def __init__(self,
        ...
        self.cylinder_3d_generator = cylin_model   #cylinder_fea_generator

        self.cylinder_3d_spconv_seg = segmentator_spconv   #Asymm_3d_spconv

        self.sparse_shape = sparse_shape

    def forward(self, train_pt_fea_ten, train_vox_ten, batch_size, val_grid=None, voting_num=4, use_tta=False, extraction='all'):
        ...
        spatial_features = self.cylinder_3d_spconv_seg(features_3d, coords, batch_size, extraction)  # [batch_size, 20, 256, 256, 32]
