...
from dataloader.pc_dataset_test import get_SemKITTI_label_name, get_eval_mask, unpack
from config.config import load_config_data
from builder import loss_builder
from builder import model_builder_unlock as model_builder
from builder import data_builder_test as data_builder
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sq_num', default='8', type=str)
    # Experiment
